...
@Component({
  selector: 'app-view-added-deduction-notice',
  templateUrl: './view-added-deduction-notice.component.html',
  styleUrls: ['./view-added-deduction-notice.component.css']
})
export class ViewAddedDeductionNoticeComponent implements OnInit {
  getReportsReq:any
  getReportsRes:any
  reportsList:any
  deleteReportReq:any
  ...
  setEnvoiceToEdite(envocie:any){
    ...
    sessionStorage.setItem('routeBack', '/viewAddeddDeductionNotice')
